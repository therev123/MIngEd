...
---------------------------------------------------------------
-- Not part of slither main, added by Philipp Geyer (Nistur) --
---------------------------------------------------------------
function classmatches(obj1, obj2)
   return type(obj1) == "table" and type(obj2) == "table" and 
          obj1.__class__ and obj2.__class__ and obj1.__class__ == obj2.__class__
end
---------------------------------------------------------------
--                                                           --
---------------------------------------------------------------