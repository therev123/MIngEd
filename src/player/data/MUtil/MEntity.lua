...
class "MEntity"
{
   ...
   --]]
   getPosition = document[[Returns an MVec3 with the entity position]](
      function(self)
   ...
   getBehavior = document[[Returns the behaviour]](
      function(self, id)
--		     rtn = MBehavior(getBehavior(self.id, id))
...
document[[Entity base class with standard accessors]](MEntity)