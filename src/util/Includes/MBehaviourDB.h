...
// MBehaviour
//
// A little wrapper around MBehavior to take
// care of a little maintenance. For now just
// inter-behaviour interactions
//--------------------------------------------
class MBehaviour : public MBehavior, public MObserver
{
public:
    ...
    MBehaviour(MObject3d * parentObject, ID id);
    ~MBehaviour();
    ...
    // Observer
    virtual void OnMessage(MMessage message, int param);
protected:
    ...
    MBehaviour* GetBehaviour(ID behaviour);
...
public:
    ...
    MBehaviour::ID GetBehaviourID(const char* name);
    ...
    MBehaviour* GetBehaviour(MObject3d* obj, MBehaviour::ID id);
    ...
    void RemoveBehaviour(MObject3d* obj, MBehaviour* behaviour);
    void RegisterBehaviour(MObject3d* obj, MBehaviour* behaviour, MBehaviour::ID id);
private:
    MBehaviourDB(){}
    MBehaviourDB(const MBehaviourDB& o){}
    ~MBehaviourDB(){}
    
    typedef std::map<MBehaviour::ID, MBehaviour*>	behaviourMap;
