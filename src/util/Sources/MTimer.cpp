...
//----------------------------------------
bool MTimer::IsRunning()
{
    return m_IsRunning;
}
//----------------------------------------
void MTimer::Update(clocktime dt)
{
...
//----------------------------------------
void MTimer::SetTimeMs(clocktime ms)
{
    m_TimeMs = ms;
}
//----------------------------------------
clocktime MTimer::GetTimeRemaining()
{
    return m_TimeMs;
}
//----------------------------------------
bool MTimer::HasExpired()
{
    return m_TimeMs <= 0;
}
//----------------------------------------
void MTimer::AddAction(ITimerAction* action)
    {
	// make sure that we haven't already
	// added this action, otherwise we
	// would get OnMTimerComplete called
	// multiple times
...
//----------------------------------------
void MTimer::RemoveAction(ITimerAction* action)
{
